...
public class HomeworkService : IHomeworkService
{
    ...
    public async Task AddHomeworkAsync(Homework newHomework, Stream file, CancellationToken token)
    {
        throw new NotImplementedException();
    }

    public async Task UpdateHomeworkAsync(Homework updatedHomework, Stream file, CancellationToken token)
    {
        throw new NotImplementedException();
    }
